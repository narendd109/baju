  ...
  <script>
    (function() {
      ...
      function handleLogin() {
        ...
        // validasi sederhana: email harus diisi, password harus 12345
        if (email === '') {
          loginError.textContent = '⚠️ Email tidak boleh kosong';
          return;
        }
        if (password === '') {
          loginError.textContent = '⚠️ Password tidak boleh kosong';
          return;
        }
        if (password !== CORRECT_PASSWORD) {
          loginError.textContent = '❌ Password salah! (gunakan 12345)';
          return;
        }
      ...
      // enter key pada input password atau email
      ...
      // jika user sudah login, refresh tidak akan memunculkan login lagi (hanya untuk demo)
      // tapi kita biarkan tetap di overlay sampai login berhasil
    })();
  </script>
</body>
</html>
